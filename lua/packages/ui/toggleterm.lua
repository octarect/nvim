...
toggleterm.setup({
  ...
  float_opts = {
    ...
    width = function()
      return vim.o.columns > 100 and vim.fn.float2nr(vim.o.columns * 0.6) or 90
    end,
    height = function()
      return vim.o.lines > 40 and vim.fn.float2nr(vim.o.lines * 5 / 8) or 24
    end,
    highlights = {
      border = "Normal",
      background = "Normal",
...
function _G.toggleterm_toggle(name)
  terminals[name].terminal:toggle()
end
